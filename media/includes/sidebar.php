        ...
        <div class="articles articles__vertical">
                ...
                <article class="article">
                    <div class="article__image"
                         style="background-image: url(/media/static/images/<?php echo $art['image']; ?>)"></div>
                    <div class="article__info">
                        <a href="/article.php?category=<?php echo $art['id']; ?>"><?php echo $art['title']; ?></a>
                        <div class="article__info__meta">
													...
													?>
                            <small>Категория: <a
                                        href="/articles.php?category=<?php echo $art_cat['id']; ?>"><?php echo $art_cat['title']; ?></a></small>
                        </div>
